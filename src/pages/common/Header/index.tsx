...
export default class Header extends React.Component<HeaderProps> {
    ...
    constructor(props: HeaderProps) {
        super(props);
        makeObservable(this, {
            menuHidden: observable, 
            handleMenuToggle: action,
            handleMenuBackgroundClick: action
        });
    }
    ...
    public handleMenuBackgroundClick(): void {
        this.menuHidden = true;
    }

    public render(): React.ReactElement {
        const menuToggleClassList: string[] = ["menu-toggle"];
        const menuClassList: string[] = ["menu"];
        const menuBackgroundClassList: string[] = ["menu-background"];
        if(!this.menuHidden) {
            document.body.classList.add("fixed");
            menuToggleClassList.push("close");
            menuClassList.push("show");
            menuBackgroundClassList.push("show");
        ...
        return <header className={style.main}>
            <div className="container">
                ...
                <div className="right">
                    <button className={menuToggleClassList.join(" ")} onClick={this.handleMenuToggle.bind(this)}>
                        <svg className="line" id="line-1" width="65" height="10" viewBox="1 1 64 9">
                            <path d="M1 1h64v9H1V1z" />
                        </svg>
                        <svg className="line" id="line-2" width="65" height="10" viewBox="1 1 64 9">
                            <path d="M1 1h64v9H1V1z" />
                        </svg>
                        <svg className="line" id="line-3" width="65" height="10" viewBox="1 1 64 9">
                            <path d="M1 1h64v9H1V1z" />
                        </svg>
                    </button>
                    <div className={menuBackgroundClassList.join(" ")} onClick={this.handleMenuBackgroundClick.bind(this)} />
                    <div className={menuClassList.join(" ")}>
                        ...
                        <NavLink className="button basket" to="/basket">
                            <svg className="icon">
                        ...
                        <span className="button search-button">
                            <svg className="icon">
